...
public class playerprofile extends javax.swing.JFrame implements ActionListener {
     ...
     void edit(String b)
    {
        try {
            ...
            else
            {
                ...
                while (rs.next()) {
                   ...
                   tp3.setText(String.valueOf(rs.getInt(16)));
     ...
     {
         try{
            stmt=c.con.prepareCall("update "+tp2.getText()+" set PLAYER=?,TESTBAT=?,ODIBAT=?,T20BAT=?,RUNS=?,FOURS=?,SIX=?,CENTURY=?,FIFTY=?,OVERS=?,WICKETS=?,TESTBALL=?,ODIBALL=?,T20BALL=?,AGE=? where PLAYER=?");
          ...
          stmt.setFloat(10, Float.parseFloat(tt2[3].getText()));
          stmt.setInt(11, Integer.parseInt(tt2[4].getText()));
          stmt.setInt(12, Integer.parseInt(tt2[0].getText()));
          stmt.setInt(13, Integer.parseInt(tt2[1].getText()));
          stmt.setInt(14, Integer.parseInt(tt2[2].getText()));
          stmt.setInt(15, Integer.parseInt(tp3.getText()));
          stmt.setString(16, tp1.getText());
          stmt.executeUpdate();   
     ...
     void add()
     {
          ...
          stmt.setFloat(11, Float.parseFloat(tt2[4].getText()));
          stmt.setInt(12, Integer.parseInt(tt2[3].getText()));
